...
<f:view id="registerOffer">
	...
	<script src="<%=request.getContextPath()%>/js/functions_ttv.js"
		type="text/javascript"></script>
	<title><h:outputText value="#{msg.registerOffer_title}"></h:outputText></title>
	<link href="<%=request.getContextPath()%>/css/estilos_ttv.css"
		rel="stylesheet" type="text/css" />
	<script>
			function setIsinMainForm(isin,nombreIsin,codigoFungible){
				document.getElementById("registerOfferForm:isinEspecie").value=isin;
				document.getElementById("registerOfferForm:codigoFungible").value=codigoFungible;
				document.getElementById("registerOfferForm:isinEspecie").onchange();				
			}
			
			function setInvestorCodeMainForm(cuentaInversionista,nombreInversionista){
				document.getElementById("registerOfferForm:cuentaInversionista").value=cuentaInversionista;
				document.getElementById("registerOfferForm:cuentaInversionista").onchange();				
			}
			
			function setDCVAccountMainForm(cuentaDCV){
				document.getElementById("registerOfferForm:cuentaDCV").value=cuentaDCV;							
			}
		</script>
	</head>
							...
							<table width="193" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="originadorpes"><h:outputText
										value="#{msg.menu_registerOfferLabel}" /></td>
									<td width="31"><img
									...
									<table width="90%" border="0" align="center" cellpadding="0"
										...
										<tr>
											<td class="tittablagenerica"><h:outputText
												value="#{msg.menu_registerOfferLabel}" />
												&nbsp;
											...
											<a4j:form id="registerOfferForm">
												...
												<table width="100%">
													...
													<tr>
														...
														<td align="right" width="15%"><h:outputText
															value="#{msg.registerOffer_specieNameLabel}"
															styleClass="generica" /></td>
														<td width="40%"><h:outputText id="nombreEspecie"
															value="#{registerOfferJSF.nombreEspecie}"
															styleClass="negrita" /></td>
													</tr>
													<tr>
														<td align="right" width="15%"><h:outputText
															value="#{msg.registerOffer_fungibleLabel}"
															styleClass="generica" /></td>
														<td width="30%"><h:inputText styleClass="generica"
															id="codigoFungible"
															value="#{registerOfferJSF.codigoFungible}">
															<a4j:support event="onchange"
																reRender="nombreEspecie,saldoIsin,panelDetalleTTV" />
														</h:inputText></td>
														<td align="right" width="15%"><h:outputText
															value="#{msg.registerOffer_investorAccountCodeLabel}"
															styleClass="generica" /></td>
														<td width="40%"><h:inputText styleClass="generica"
															id="cuentaInversionista"
															value="#{registerOfferJSF.cuentaInversionista}">
															<a4j:support event="onchange"
													...
													<tr>
														<td align="right" width="15%"><h:outputText
															value="#{msg.registerOffer_balanceLabel}"
															styleClass="generica" /></td>
														<td width="30%"><h:outputText id="saldoIsin"
															value="#{registerOfferJSF.saldoIsin}"
															styleClass="negrita">
															<f:convertNumber
																pattern="###,###,###,###,###,###,###,###,###.##" />
														</h:outputText></td>
														<td align="right" width="15%"><h:outputText
															value="#{msg.registerOffer_investorAccountNameLabel}"
															styleClass="generica" /></td>
														<td width="40%"><h:outputText
															id="nombreInversionista"
															value="#{registerOfferJSF.nombreInversionista}"
															styleClass="negrita" /></td>
													</tr>
													<tr>
														<td colspan="4">&nbsp;</td>
												...
												<a4j:outputPanel id="panelDetalleTTV">
													<table width="100%">
														<tr>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_amountTTVLabel}"
																styleClass="generica" /></td>
															<td width="30%"><h:inputText styleClass="generica"
																id="cantidadPrestar"
																value="#{registerOfferJSF.cantidadPrestar}">
																<a4j:support event="onchange"
																	reRender="valorizado,prima" />
															</h:inputText></td>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_rateTTVLabel}"
																styleClass="generica" /></td>
															<td width="40%"><h:inputText styleClass="generica"
																id="tasaPrestamo"
																value="#{registerOfferJSF.tasaPrestamo}">
																<a4j:support event="onchange" reRender="prima" />
															</h:inputText></td>
														</tr>
														<tr>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_haircuteRateTTVLabel}"
																styleClass="generica" /></td>
															<td width="30%"><h:outputText id="tasaCobertura"
																value="#{registerOfferJSF.tasaCobertura}"
																styleClass="generica">
																<f:convertNumber pattern="####.##" />
															</h:outputText></td>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_profitTTVLabel}"
																styleClass="generica" /></td>
															<td width="40%"><h:outputText id="prima"
																value="#{registerOfferJSF.prima}" styleClass="generica">
																<f:convertNumber pattern="###,###,###,###,###,###.##" />
															</h:outputText></td>
														</tr>
														<tr>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_valueTVVLabel}"
																styleClass="generica" /></td>
															<td width="30%"><h:outputText id="valorizado"
																value="#{registerOfferJSF.valorizado}"
																styleClass="generica">
																<f:convertNumber
																	pattern="###,###,###,###,###,###,###,###,###.##" />
															</h:outputText></td>
														...
														<tr>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_endDateLabel}"
																styleClass="generica" /></td>
															<td width="30%"><rich:calendar id="fechaVencimiento"
																value="#{registerOfferJSF.fechaVencimiento}"
																popup="true" datePattern="dd/MM/yyyy"
																enableManualInput="true" showApplyButton="false"
																cellWidth="24px" cellHeight="22px" style="width:25%"
																ondateselect="setTimeout('$(\"registerOfferForm:fechaVencimientoInputDate\").onchange()',10);">
																<a4j:support event="oninputchange" reRender="plazo" />
															</rich:calendar></td>
																...
																<table width="100%" cellpadding="0" cellspacing="0"
																	...
																	<tr>
																		<td align="right" width="27%"><h:outputText
																			id="cuentaDCVLabel"
																			value="#{msg.registerOffer_DCVaccountNumberLabel}"
																			styleClass="generica"/></td>
																		<td width="1%">&nbsp;</td>
																		<td width="72%"><h:inputText
																			styleClass="generica" id="cuentaDCV"
																			value="#{registerOfferJSF.cuentaDCV}" /><h:outputLink
														...
														<tr>
															<td align="right" width="15%"><h:outputText
																value="#{msg.registerOffer_daysBetweenDatesLabel}"
																styleClass="generica" /></td>
															<td width="30%"><h:outputText id="plazo"
																value="#{registerOfferJSF.plazo}" styleClass="generica" /></td>
												...
												<table width="100%">
													<tr>
														<td align="right" width="60%"><h:commandButton
															...
															onclick="if(!confirm('#{msg.registerOffer_cancelButtonConfirmMessage}')){return false;};"
															value="#{msg.registerOffer_cancelButtonText}"></h:commandButton></td>
														<td>															
															<h:commandButton styleClass="button"
																id="grabarOferta" type="submit"
																action="#{registerOfferJSF.grabarOferta}"
																onclick="if(!confirm('#{msg.registerOffer_saveButtonConfirmMessage}')){return false;}"
																value="#{msg.registerOffer_saveButtonText}" />
														</td>
													</tr>
												</table>
											</a4j:form></td>
	...
	<a4j:include id="helpIsin" viewId="/jsp/common/isinHelp.jsp" />
